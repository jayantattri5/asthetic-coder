...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Asthetic coder',
  SIGNIN_SUBHEADING: 'To use Asthetic Coder you must log into an existing account or create one.',
  SIGNIN_AGREEMENT_TEXT: 'By using Asthetic Coder, you agree to the collection of usage data for analytics.',
